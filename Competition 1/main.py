# "When the Universe is About to Give you something GREAT, It First tests you with your hardest Times"
# -Devang Sharma
...
df = pd.read_csv(r'D:\OneDrive\Music\codeleague-master/order_brush_order.csv')
